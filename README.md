...
> 작성 전: 아래 항목은 작성자가 실제 작업 이력에 맞게 채워야 합니다. 공개 제출 전에 이 안내와 미작성 항목을 정리할 예정입니다.

- **직접 설계·작성한 기능:** [작성 필요: 기능 이름, 파일 링크, 담당 범위]
- **기존 코드 또는 AI 제안을 직접 수정한 사례:** [작성 필요: 문제, 직접 변경한 내용, 파일 링크]
- **직접 확인한 과정:** [작성 필요: 디버깅 방법, 테스트 조건, 확인 결과]
