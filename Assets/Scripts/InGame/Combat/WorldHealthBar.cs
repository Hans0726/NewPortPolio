...
public class WorldHealthBar : MonoBehaviour
{
    ...
    public static WorldHealthBar Create(Transform target, Vector3 offset, Vector2 size, Color fillColor, int sortingLayerId, int sortingOrder)
    {
        ...
        bar.Initialize(target, offset, size, fillColor, sortingLayerId, sortingOrder);
        return bar;
    }
    ...
    private void Initialize(Transform target, Vector3 offset, Vector2 size, Color fillColor, int sortingLayerId, int sortingOrder)
    {
        _target = target;
        _offset = offset;
