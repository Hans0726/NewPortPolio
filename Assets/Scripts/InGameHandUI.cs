...
{
    public static InGameHandUI Instance { get; private set; }
    ...
    {
        if (InGameCardManager.Instance != null && _isInitialized)
        {
    ...
    public void Initialize()
    {
        ...
        {
            Debug.LogError("[InGameHandUI] InGameCardManager is missing.");
            return;
        }
    ...
    private void HandleInitialHandDrawn()
    {
        ...
        List<CardData> hand = InGameCardManager.Instance.PlayerHand;
        for (int i = 0; i < hand.Count; i++)
        {
            ...
            cardUI.SetPlayableState(GameTurnManager.Instance != null
                ? GameTurnManager.Instance.CurrentCost
                : 0);
    ...
    public void RejectCardUse(GameObject cardRoot)
    {
        ...
        _pendingCardOriginalIndex = -1;
        UpdateCardInteractableStates(GameTurnManager.Instance != null
            ? GameTurnManager.Instance.CurrentCost
            : 0);
    }
